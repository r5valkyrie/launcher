...
namespace launcher.Services
{
    public static class ReleaseChannelService
    {
        ...
        public static string GetDirectory(ReleaseChannel channel = null) { return channel != null ? Path.Combine((string)SettingsService.Get(SettingsService.Vars.Library_Location), "R5Valk Library", GetName(true, channel)) : Path.Combine((string)SettingsService.Get(SettingsService.Vars.Library_Location), "R5Valk Library", GetName()); }
